...
<body>
    <div class="container">
        <h1>Welcome to Adampur Gonda</h1>
        <p>Enter your details and Sumilt form </p>


        <?php
        if($insert == true){
          echo "<p class='submitmsg'>Thanks for submitting your form. We are happy to see you joining us for the Indian trip</p>";
        }
        ?>
